...
Qwen 3.5-397 B-A 17 B

今天 19:51

这是一个为你整理的 **NumPy 核心知识点** Markdown 文件，专为 **Obsidian** 优化。

它包含了你刚刚完成的三个作业（Exercise 1.01, 1.02, 1.03）中的所有关键概念，并进行了适当的延伸和结构化整理。你可以直接复制下面的代码块，保存为 `CISC7204_NumPy_CheatSheet.md` 然后放入你的 Obsidian 仓库中。
