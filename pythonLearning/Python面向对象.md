...
-   现实世界的事物都有属性和行为,可在程序中抽离为类来描述现实世界的事物属性和行为。
    ![[Pasted image 20260518101251.png]]
...
-   <mark class="eme-highlight eme-h-blue" data-id="a2332595-0c7e-49ab-8b9b-9220195518ab">多态常作用在继承关系上，函数(方法)形参声明接收父类对象，实际传入父类的子类对象进行工作</mark>，即
